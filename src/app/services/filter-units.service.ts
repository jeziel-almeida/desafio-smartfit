...
export class FilterUnitsService {
  ...
  filterUnits(unit: UnitLocation, open_hour: string, close_hour: string) {
  ...
  //Filtra as unidades por unidades abertas ou fechadas e também pelo período do dia:
  filter(results: UnitLocation[], showClosed: boolean, hour: string): UnitLocation[] {
